...
public class P01 {
    ...
    public static void main(String[] args) {
        ...
        //-bu web adresinin sayfa basligini(title) ve adres(url)ini yazdıralım
        String actualTitle=driver.getTitle(); //usul bu
        System.out.println("Sayfa Başlığı :" +actualTitle);
        String actualUrl=driver.getCurrentUrl();//usul
        System.out.println("Sayfa Url'i :" +actualUrl);

        //System.out.println("Title:"  +driver.getTitle());
        //System.out.println("Adres:" +driver.getCurrentUrl());

        //driver.navigate().refresh(); bu sitede doğrulama istendiğinde  yapmalısın
